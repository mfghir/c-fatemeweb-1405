...
export const COPY: Record<Locale, Copy> = {
  fa: {
    ...
    hiPrefix: "سلام، من",
    name: "فاطمه غفاری",
    tagline: "طراح UI/UX هستم؛ کمتر دنبال قشنگ‌کردن صفحه‌ام، بیشتر دنبال این‌که محصول واقعاً کار کنه — از تحقیق کاربر تا لحظه‌ای که فایل رو تحویل توسعه‌دهنده می‌دم.",
  ...
  en: {
    ...
    hiPrefix: "Hi, I'm",
    name: "Fateme Ghafari",
    tagline: "UI/UX designer who cares less about making things look nice and more about making them work — from user research through the moment a developer opens the file.",
