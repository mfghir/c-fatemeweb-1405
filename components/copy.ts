...
export const COPY: Record<Locale, Copy> = {
  fa: {
    ...
    stat1n: "۲۰۰۰+", stat1l: "ساعت طراحی با قهوه و فیگما",
    stat2n: "۵+", stat2l: "همکاری بلندمدت با تیم‌های محصول",
  ...
  en: {
    ...
    stat1n: "2000+", stat1l: "hours of design, coffee & Figma",
    stat2n: "5+", stat2l: "long-term collaborations with product teams",
    canvasTitle: "artboard.fig",
  ...
  ko: {
    ...
    stat1n: "2000+", stat1l: "시간의 디자인, 커피 그리고 Figma",
    stat2n: "5+", stat2l: "제품 팀과의 장기 협업",
    canvasTitle: "artboard.fig",
